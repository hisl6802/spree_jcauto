module Spree
  module Admin
    class PaymentMethodsController < ResourceController
      #Does the payment get processed or does it get sent to the admin account?
      #Given that this is the backend this is likely going to run a check for the payments if they were made.
