module Spree
  module Admin
    class BaseController < Spree::BaseController
      ...
      #How are these helpers helping the webpage...
      helper 'spree/admin/navigation'
      helper 'spree/admin/tables'
      layout '/spree/layouts/admin'

      #makes sure that the program checks for alerts and authorizes the admin. before allowing any changes to be made to the admin. backend of the webpage.
      ...
      protected
        ...
        #ensures that a customers information is completely filled out before advancing to the next page.
